...
//                    displayAccelerometerReading(accelerometerValues[0], accelerometerValues[1], accelerometerValues[2]);
     ...
     */
    private void displayLastThrow(final int stepCount){
        getActivity().runOnUiThread(new Runnable() {
            @Override
            public void run() {
                txtLastThrow.setText(String.format(Locale.getDefault(), getString(R.string.highest_jump), stepCount));
            }
        });
    }
     ...
     * @param stepCount the number of steps taken since the service started
     */
    private void displayFurthestThrow(final int stepCount){
        getActivity().runOnUiThread(new Runnable() {
            @Override
            public void run() {
                txtFurthestThrow.setText(String.format(Locale.getDefault(), getString(R.string.highest_jump), stepCount));
            }
        });
    }
